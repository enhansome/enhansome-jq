...
* [jq](https://jqlang.github.io/jq/) ([github](https://github.com/jqlang/jq) ⭐ 35,590 | 🐛 480 | 🌐 C | 📅 2026-09-01) – The original jq command-line JSON processor.
* [gojq](https://github.com/itchyny/gojq) ⭐ 3,803 | 🐛 18 | 🌐 Go | 📅 2026-09-13 – A jq implementation in Go.
* [jqjq](https://github.com/wader/jqjq) ⭐ 770 | 🐛 6 | 🌐 jq | 📅 2026-08-02 – jq implementation of jq
* [query-json (`q`)](https://github.com/davesnx/query-json) ⭐ 636 | 🐛 2 | 🌐 OCaml | 📅 2026-09-03 – query-json is a faster, simpler and more portable implementation of the jq language in Reason.
* [xq](https://github.com/MiSawa/xq) ⭐ 402 | 🐛 14 | 🌐 Rust | 📅 2026-07-10 – Pure rust implementation of jq
* [jq.js](https://github.com/mwh/jqjs) ⭐ 104 | 🐛 1 | 🌐 JavaScript | 📅 2026-08-23 – Pure Javascript implementation of jq
...
* `echo '' | fzf --print-query --preview "cat *.json | jq {q}"` – An [fzf](https://github.com/junegunn/fzf) ⭐ 82,959 | 🐛 328 | 🌐 Go | 📅 2026-09-13 hack that turns it into an interactive jq explorer.
* [fq](https://github.com/wader/fq) ⭐ 10,595 | 🐛 58 | 🌐 Go | 📅 2026-09-12 – jq for binary formats
* [jnv](https://github.com/ynqa/jnv) ⭐ 6,104 | 🐛 31 | 🌐 Rust | 📅 2026-08-20 – interactive JSON filter using jq with navigation and autocompletion.
* [yq](https://github.com/kislyuk/yq) ⭐ 2,975 | 🐛 23 | 🌐 Python | 📅 2026-07-11 (and `xq`) – jq wrapper for YAML and XML documents.
* [jqp](https://github.com/noahgorstein/jqp) ⭐ 2,839 | 🐛 24 | 🌐 Go | 📅 2026-02-06 – a TUI playground for exploring jq.
* [jiq](https://github.com/fiatjaf/jiq) ⚠️ Archived – A visual command-line interactive JSON explorer with jq filters.
* [play](https://github.com/paololazzari/play) ⭐ 587 | 🐛 3 | 🌐 Go | 📅 2025-03-28 – A TUI playground to experiment with your favorite programs, such as grep, sed, awk, jq and yq.
...
* [jqfmt](https://github.com/noperator/jqfmt) ⭐ 410 | 🐛 8 | 🌐 Go | 📅 2026-02-03 – A code beautifier for jq.
...
* [ijq](https://github.com/fiatjaf/ijq) ⭐ 29 | 🐛 0 | 🌐 Go | 📅 2022-09-21 – jq REPL with automatic variable assignment and global statements support.
...
* [jq play](https://jqplay.org/) ([github](https://github.com/jingweno/jqplay) ⭐ 849 | 🐛 31 | 🌐 TypeScript | 📅 2026-09-11) – A playground for jq with sharing capabilities.
...
* [jqp](https://github.com/sighrobot/jqp) ⭐ 16 | 🐛 0 | 🌐 JavaScript | 📅 2023-07-19 – A free serverless proxy for filtering JSON and CSV data using jq.
...
* [bat syntax highlighting](https://github.com/jqlang/jq/wiki/bat-language-syntax) ⭐ 35,590 | 🐛 480 | 🌐 C | 📅 2026-09-01 – Syntax file to use bat to syntax highlight jq files
* [jq-mode](https://github.com/ljos/jq-mode) ⭐ 134 | 🐛 9 | 🌐 Emacs Lisp | 📅 2026-08-21 – A jq mode for Emacs.
* [jq-lsp](https://github.com/wader/jq-lsp) ⭐ 133 | 🐛 7 | 🌐 jq | 📅 2026-08-03 – jq language server. Works with VSCode, neovim and Emacs. Has syntax and scope checking, goto defintion, completion and hover documentation.
...
* [virtual-json-viewer](https://github.com/paolosimone/virtual-json-viewer) ⭐ 84 | 🐛 3 | 🌐 TypeScript | 📅 2026-08-30 – A JSON Chrome/Firefox Extension with virtual DOM, full-text search and jq filtering.
* [vscode-jq-playground](https://github.com/davidnussio/vscode-jq-playground) ⭐ 54 | 🐛 13 | 🌐 TypeScript | 📅 2026-09-11 – A jq playground notebook extension for VS Code.
...
* [vscode-jq](https://github.com/wader/vscode-jq) ⭐ 32 | 🐛 4 | 🌐 TypeScript | 📅 2026-09-13 – VSCode jq extension that uses [jq-lsp](https://github.com/wader/jq-lsp) ⭐ 133 | 🐛 7 | 🌐 jq | 📅 2026-08-03. Has syntax highlight, snippets and everything jq-lsp provides.
...
* [FAQ](https://github.com/jqlang/jq/wiki/FAQ) ⭐ 35,590 | 🐛 480 | 🌐 C | 📅 2026-09-01 – jq FAQ.
* [Cookbook](https://github.com/jqlang/jq/wiki/Cookbook) ⭐ 35,590 | 🐛 480 | 🌐 C | 📅 2026-09-01 – jq cookbook.
* [Advanced Topics](https://github.com/jqlang/jq/wiki/Advanced-Topics) ⭐ 35,590 | 🐛 480 | 🌐 C | 📅 2026-09-01 – jq advanced topics.
...
* [Builtins](https://github.com/jqlang/jq/blob/master/src/builtin.jq) ⭐ 35,590 | 🐛 480 | 🌐 C | 📅 2026-09-01 – jq builtins coded in *jq* itself, not C.
...
* [jc](https://github.com/kellyjonbrazil/jc) ⭐ 8,675 | 🐛 41 | 🌐 Python | 📅 2026-09-10 – CLI tool that converts the output of popular command-line programs and filetypes to JSON so they can be piped to jq.
...
* [gojq](https://github.com/itchyny/gojq) ⭐ 3,803 | 🐛 18 | 🌐 Go | 📅 2026-09-13 – A full jq implementation in Go, usable as a library.
* [jq.py](https://github.com/mwilliamson/jq.py) ⭐ 454 | 🐛 28 | 🌐 Python | 📅 2026-07-10 – Another jq wrapper for Python.
...
* [jqr](https://github.com/ropensci/jqr) ⭐ 145 | 🐛 16 | 🌐 R | 📅 2024-12-14 – R interface to jq.
* [java-jq](https://github.com/arakelian/java-jq) ⭐ 93 | 🐛 8 | 🌐 Java | 📅 2024-04-30 – A jq wrapper for Java ([jackson-jq](https://github.com/eiiches/jackson-jq) ⭐ 310 | 🐛 12 | 🌐 Java | 📅 2026-09-13 is a Jackson extension).
