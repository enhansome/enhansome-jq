...
* [jq](https://jqlang.github.io/jq/) ([github](https://github.com/jqlang/jq) ⭐ 35,588 | 🐛 480 | 🌐 C | 📅 2026-09-01) – The original jq command-line JSON processor.
* [gojq](https://github.com/itchyny/gojq) ⭐ 3,803 | 🐛 19 | 🌐 Go | 📅 2026-09-04 – A jq implementation in Go.
...
* `echo '' | fzf --print-query --preview "cat *.json | jq {q}"` – An [fzf](https://github.com/junegunn/fzf) ⭐ 82,929 | 🐛 328 | 🌐 Go | 📅 2026-09-12 hack that turns it into an interactive jq explorer.
* [fq](https://github.com/wader/fq) ⭐ 10,595 | 🐛 57 | 🌐 Go | 📅 2026-09-10 – jq for binary formats
...
* [bat syntax highlighting](https://github.com/jqlang/jq/wiki/bat-language-syntax) ⭐ 35,588 | 🐛 480 | 🌐 C | 📅 2026-09-01 – Syntax file to use bat to syntax highlight jq files
...
* [vscode-jq](https://github.com/wader/vscode-jq) ⭐ 32 | 🐛 3 | 🌐 TypeScript | 📅 2026-09-02 – VSCode jq extension that uses [jq-lsp](https://github.com/wader/jq-lsp) ⭐ 133 | 🐛 7 | 🌐 jq | 📅 2026-08-03. Has syntax highlight, snippets and everything jq-lsp provides.
...
* [FAQ](https://github.com/jqlang/jq/wiki/FAQ) ⭐ 35,588 | 🐛 480 | 🌐 C | 📅 2026-09-01 – jq FAQ.
* [Cookbook](https://github.com/jqlang/jq/wiki/Cookbook) ⭐ 35,588 | 🐛 480 | 🌐 C | 📅 2026-09-01 – jq cookbook.
* [Advanced Topics](https://github.com/jqlang/jq/wiki/Advanced-Topics) ⭐ 35,588 | 🐛 480 | 🌐 C | 📅 2026-09-01 – jq advanced topics.
...
* [Builtins](https://github.com/jqlang/jq/blob/master/src/builtin.jq) ⭐ 35,588 | 🐛 480 | 🌐 C | 📅 2026-09-01 – jq builtins coded in *jq* itself, not C.
...
* [jc](https://github.com/kellyjonbrazil/jc) ⭐ 8,673 | 🐛 42 | 🌐 Python | 📅 2026-09-10 – CLI tool that converts the output of popular command-line programs and filetypes to JSON so they can be piped to jq.
...
* [gojq](https://github.com/itchyny/gojq) ⭐ 3,803 | 🐛 19 | 🌐 Go | 📅 2026-09-04 – A full jq implementation in Go, usable as a library.
...
* [java-jq](https://github.com/arakelian/java-jq) ⭐ 93 | 🐛 8 | 🌐 Java | 📅 2024-04-30 – A jq wrapper for Java ([jackson-jq](https://github.com/eiiches/jackson-jq) ⭐ 310 | 🐛 12 | 🌐 Java | 📅 2026-09-12 is a Jackson extension).
