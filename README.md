...
* [jq](https://jqlang.github.io/jq/) ([github](https://github.com/jqlang/jq) ⭐ 35,617 | 🐛 472 | 🌐 C | 📅 2026-09-18) – The original jq command-line JSON processor.
* [gojq](https://github.com/itchyny/gojq) ⭐ 3,804 | 🐛 18 | 🌐 Go | 📅 2026-09-18 – A jq implementation in Go.
...
* `echo '' | fzf --print-query --preview "cat *.json | jq {q}"` – An [fzf](https://github.com/junegunn/fzf) ⭐ 83,101 | 🐛 329 | 🌐 Go | 📅 2026-09-14 hack that turns it into an interactive jq explorer.
* [fq](https://github.com/wader/fq) ⭐ 10,596 | 🐛 58 | 🌐 Go | 📅 2026-09-15 – jq for binary formats
* [jnv](https://github.com/ynqa/jnv) ⭐ 6,114 | 🐛 32 | 🌐 Rust | 📅 2026-09-17 – interactive JSON filter using jq with navigation and autocompletion.
* [yq](https://github.com/kislyuk/yq) ⭐ 2,980 | 🐛 23 | 🌐 Python | 📅 2026-07-11 (and `xq`) – jq wrapper for YAML and XML documents.
* [jqp](https://github.com/noahgorstein/jqp) ⭐ 2,843 | 🐛 24 | 🌐 Go | 📅 2026-02-06 – a TUI playground for exploring jq.
* [jiq](https://github.com/fiatjaf/jiq) ⚠️ Archived – A visual command-line interactive JSON explorer with jq filters.
* [play](https://github.com/paololazzari/play) ⭐ 589 | 🐛 3 | 🌐 Go | 📅 2025-03-28 – A TUI playground to experiment with your favorite programs, such as grep, sed, awk, jq and yq.
...
* [bat syntax highlighting](https://github.com/jqlang/jq/wiki/bat-language-syntax) ⭐ 35,617 | 🐛 472 | 🌐 C | 📅 2026-09-18 – Syntax file to use bat to syntax highlight jq files
...
* [virtual-json-viewer](https://github.com/paolosimone/virtual-json-viewer) ⭐ 85 | 🐛 3 | 🌐 TypeScript | 📅 2026-08-30 – A JSON Chrome/Firefox Extension with virtual DOM, full-text search and jq filtering.
...
* [FAQ](https://github.com/jqlang/jq/wiki/FAQ) ⭐ 35,617 | 🐛 472 | 🌐 C | 📅 2026-09-18 – jq FAQ.
* [Cookbook](https://github.com/jqlang/jq/wiki/Cookbook) ⭐ 35,617 | 🐛 472 | 🌐 C | 📅 2026-09-18 – jq cookbook.
* [Advanced Topics](https://github.com/jqlang/jq/wiki/Advanced-Topics) ⭐ 35,617 | 🐛 472 | 🌐 C | 📅 2026-09-18 – jq advanced topics.
...
* [Builtins](https://github.com/jqlang/jq/blob/master/src/builtin.jq) ⭐ 35,617 | 🐛 472 | 🌐 C | 📅 2026-09-18 – jq builtins coded in *jq* itself, not C.
...
* [jc](https://github.com/kellyjonbrazil/jc) ⭐ 8,677 | 🐛 47 | 🌐 Python | 📅 2026-09-17 – CLI tool that converts the output of popular command-line programs and filetypes to JSON so they can be piped to jq.
...
* [gojq](https://github.com/itchyny/gojq) ⭐ 3,804 | 🐛 18 | 🌐 Go | 📅 2026-09-18 – A full jq implementation in Go, usable as a library.
* [jq.py](https://github.com/mwilliamson/jq.py) ⭐ 454 | 🐛 28 | 🌐 Python | 📅 2026-09-18 – Another jq wrapper for Python.
...
* [java-jq](https://github.com/arakelian/java-jq) ⭐ 93 | 🐛 8 | 🌐 Java | 📅 2024-04-30 – A jq wrapper for Java ([jackson-jq](https://github.com/eiiches/jackson-jq) ⭐ 310 | 🐛 7 | 🌐 Java | 📅 2026-09-18 is a Jackson extension).
