...
* [jq](https://jqlang.github.io/jq/) ([github](https://github.com/jqlang/jq) ⭐ 35,654 | 🐛 450 | 🌐 C | 📅 2026-09-19) – The original jq command-line JSON processor.
* [gojq](https://github.com/itchyny/gojq) ⭐ 3,805 | 🐛 18 | 🌐 Go | 📅 2026-09-19 – A jq implementation in Go.
* [jqjq](https://github.com/wader/jqjq) ⭐ 771 | 🐛 6 | 🌐 jq | 📅 2026-08-02 – jq implementation of jq
* [query-json (`q`)](https://github.com/davesnx/query-json) ⭐ 636 | 🐛 5 | 🌐 OCaml | 📅 2026-09-21 – query-json is a faster, simpler and more portable implementation of the jq language in Reason.
...
* `echo '' | fzf --print-query --preview "cat *.json | jq {q}"` – An [fzf](https://github.com/junegunn/fzf) ⭐ 83,171 | 🐛 330 | 🌐 Go | 📅 2026-09-21 hack that turns it into an interactive jq explorer.
* [fq](https://github.com/wader/fq) ⭐ 10,596 | 🐛 58 | 🌐 Go | 📅 2026-09-19 – jq for binary formats
* [jnv](https://github.com/ynqa/jnv) ⭐ 6,116 | 🐛 32 | 🌐 Rust | 📅 2026-09-17 – interactive JSON filter using jq with navigation and autocompletion.
* [yq](https://github.com/kislyuk/yq) ⭐ 2,982 | 🐛 22 | 🌐 Python | 📅 2026-09-19 (and `xq`) – jq wrapper for YAML and XML documents.
...
* [jqfmt](https://github.com/noperator/jqfmt) ⭐ 411 | 🐛 8 | 🌐 Go | 📅 2026-02-03 – A code beautifier for jq.
...
* [bat syntax highlighting](https://github.com/jqlang/jq/wiki/bat-language-syntax) ⭐ 35,654 | 🐛 450 | 🌐 C | 📅 2026-09-19 – Syntax file to use bat to syntax highlight jq files
...
* [vscode-jq-playground](https://github.com/davidnussio/vscode-jq-playground) ⭐ 54 | 🐛 13 | 🌐 TypeScript | 📅 2026-09-19 – A jq playground notebook extension for VS Code.
...
* [FAQ](https://github.com/jqlang/jq/wiki/FAQ) ⭐ 35,654 | 🐛 450 | 🌐 C | 📅 2026-09-19 – jq FAQ.
* [Cookbook](https://github.com/jqlang/jq/wiki/Cookbook) ⭐ 35,654 | 🐛 450 | 🌐 C | 📅 2026-09-19 – jq cookbook.
* [Advanced Topics](https://github.com/jqlang/jq/wiki/Advanced-Topics) ⭐ 35,654 | 🐛 450 | 🌐 C | 📅 2026-09-19 – jq advanced topics.
...
* [Builtins](https://github.com/jqlang/jq/blob/master/src/builtin.jq) ⭐ 35,654 | 🐛 450 | 🌐 C | 📅 2026-09-19 – jq builtins coded in *jq* itself, not C.
...
* [jc](https://github.com/kellyjonbrazil/jc) ⭐ 8,681 | 🐛 28 | 🌐 Python | 📅 2026-09-19 – CLI tool that converts the output of popular command-line programs and filetypes to JSON so they can be piped to jq.
...
* [gojq](https://github.com/itchyny/gojq) ⭐ 3,805 | 🐛 18 | 🌐 Go | 📅 2026-09-19 – A full jq implementation in Go, usable as a library.
...
* [java-jq](https://github.com/arakelian/java-jq) ⭐ 93 | 🐛 8 | 🌐 Java | 📅 2024-04-30 – A jq wrapper for Java ([jackson-jq](https://github.com/eiiches/jackson-jq) ⭐ 310 | 🐛 11 | 🌐 Java | 📅 2026-09-21 is a Jackson extension).
