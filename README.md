...
* [jq](https://jqlang.github.io/jq/) ([github](https://github.com/jqlang/jq) ⭐ 35,687 | 🐛 448 | 🌐 C | 📅 2026-09-25) – The original jq command-line JSON processor.
* [gojq](https://github.com/itchyny/gojq) ⭐ 3,807 | 🐛 16 | 🌐 Go | 📅 2026-09-24 – A jq implementation in Go.
* [jqjq](https://github.com/wader/jqjq) ⭐ 771 | 🐛 6 | 🌐 jq | 📅 2026-08-02 – jq implementation of jq
* [query-json (`q`)](https://github.com/davesnx/query-json) ⭐ 636 | 🐛 4 | 🌐 OCaml | 📅 2026-09-24 – query-json is a faster, simpler and more portable implementation of the jq language in Reason.
...
* `echo '' | fzf --print-query --preview "cat *.json | jq {q}"` – An [fzf](https://github.com/junegunn/fzf) ⭐ 83,242 | 🐛 331 | 🌐 Go | 📅 2026-09-21 hack that turns it into an interactive jq explorer.
* [fq](https://github.com/wader/fq) ⭐ 10,598 | 🐛 60 | 🌐 Go | 📅 2026-09-24 – jq for binary formats
* [jnv](https://github.com/ynqa/jnv) ⭐ 6,117 | 🐛 32 | 🌐 Rust | 📅 2026-09-24 – interactive JSON filter using jq with navigation and autocompletion.
* [yq](https://github.com/kislyuk/yq) ⭐ 2,986 | 🐛 22 | 🌐 Python | 📅 2026-09-19 (and `xq`) – jq wrapper for YAML and XML documents.
...
* [jqfmt](https://github.com/noperator/jqfmt) ⭐ 412 | 🐛 8 | 🌐 Go | 📅 2026-02-03 – A code beautifier for jq.
...
* [jq play](https://jqplay.org/) ([github](https://github.com/jingweno/jqplay) ⭐ 850 | 🐛 31 | 🌐 TypeScript | 📅 2026-09-11) – A playground for jq with sharing capabilities.
...
* [bat syntax highlighting](https://github.com/jqlang/jq/wiki/bat-language-syntax) ⭐ 35,687 | 🐛 448 | 🌐 C | 📅 2026-09-25 – Syntax file to use bat to syntax highlight jq files
* [jq-mode](https://github.com/ljos/jq-mode) ⭐ 134 | 🐛 9 | 🌐 Emacs Lisp | 📅 2026-08-21 – A jq mode for Emacs.
* [jq-lsp](https://github.com/wader/jq-lsp) ⭐ 134 | 🐛 7 | 🌐 jq | 📅 2026-08-03 – jq language server. Works with VSCode, neovim and Emacs. Has syntax and scope checking, goto defintion, completion and hover documentation.
...
* [vscode-jq-playground](https://github.com/davidnussio/vscode-jq-playground) ⭐ 54 | 🐛 13 | 🌐 TypeScript | 📅 2026-09-25 – A jq playground notebook extension for VS Code.
...
* [vscode-jq](https://github.com/wader/vscode-jq) ⭐ 32 | 🐛 3 | 🌐 TypeScript | 📅 2026-09-14 – VSCode jq extension that uses [jq-lsp](https://github.com/wader/jq-lsp) ⭐ 134 | 🐛 7 | 🌐 jq | 📅 2026-08-03. Has syntax highlight, snippets and everything jq-lsp provides.
...
* [FAQ](https://github.com/jqlang/jq/wiki/FAQ) ⭐ 35,687 | 🐛 448 | 🌐 C | 📅 2026-09-25 – jq FAQ.
* [Cookbook](https://github.com/jqlang/jq/wiki/Cookbook) ⭐ 35,687 | 🐛 448 | 🌐 C | 📅 2026-09-25 – jq cookbook.
* [Advanced Topics](https://github.com/jqlang/jq/wiki/Advanced-Topics) ⭐ 35,687 | 🐛 448 | 🌐 C | 📅 2026-09-25 – jq advanced topics.
...
* [Builtins](https://github.com/jqlang/jq/blob/master/src/builtin.jq) ⭐ 35,687 | 🐛 448 | 🌐 C | 📅 2026-09-25 – jq builtins coded in *jq* itself, not C.
...
* [jc](https://github.com/kellyjonbrazil/jc) ⭐ 8,686 | 🐛 35 | 🌐 Python | 📅 2026-09-23 – CLI tool that converts the output of popular command-line programs and filetypes to JSON so they can be piped to jq.
...
* [gojq](https://github.com/itchyny/gojq) ⭐ 3,807 | 🐛 16 | 🌐 Go | 📅 2026-09-24 – A full jq implementation in Go, usable as a library.
...
* [java-jq](https://github.com/arakelian/java-jq) ⭐ 93 | 🐛 8 | 🌐 Java | 📅 2024-04-30 – A jq wrapper for Java ([jackson-jq](https://github.com/eiiches/jackson-jq) ⭐ 310 | 🐛 12 | 🌐 Java | 📅 2026-09-25 is a Jackson extension).
