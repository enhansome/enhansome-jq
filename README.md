...
* [jq](https://jqlang.github.io/jq/) ([github](https://github.com/jqlang/jq) ⭐ 35,518 | 🐛 473 | 🌐 C | 📅 2026-08-23) – The original jq command-line JSON processor.
...
* `echo '' | fzf --print-query --preview "cat *.json | jq {q}"` – An [fzf](https://github.com/junegunn/fzf) ⭐ 82,731 | 🐛 327 | 🌐 Go | 📅 2026-08-26 hack that turns it into an interactive jq explorer.
* [fq](https://github.com/wader/fq) ⭐ 10,585 | 🐛 58 | 🌐 Go | 📅 2026-08-29 – jq for binary formats
...
* [yq](https://github.com/kislyuk/yq) ⭐ 2,973 | 🐛 23 | 🌐 Python | 📅 2026-07-11 (and `xq`) – jq wrapper for YAML and XML documents.
...
* [bat syntax highlighting](https://github.com/jqlang/jq/wiki/bat-language-syntax) ⭐ 35,518 | 🐛 473 | 🌐 C | 📅 2026-08-23 – Syntax file to use bat to syntax highlight jq files
...
* [virtual-json-viewer](https://github.com/paolosimone/virtual-json-viewer) ⭐ 83 | 🐛 4 | 🌐 TypeScript | 📅 2026-08-30 – A JSON Chrome/Firefox Extension with virtual DOM, full-text search and jq filtering.
...
* [FAQ](https://github.com/jqlang/jq/wiki/FAQ) ⭐ 35,518 | 🐛 473 | 🌐 C | 📅 2026-08-23 – jq FAQ.
* [Cookbook](https://github.com/jqlang/jq/wiki/Cookbook) ⭐ 35,518 | 🐛 473 | 🌐 C | 📅 2026-08-23 – jq cookbook.
* [Advanced Topics](https://github.com/jqlang/jq/wiki/Advanced-Topics) ⭐ 35,518 | 🐛 473 | 🌐 C | 📅 2026-08-23 – jq advanced topics.
...
* [Builtins](https://github.com/jqlang/jq/blob/master/src/builtin.jq) ⭐ 35,518 | 🐛 473 | 🌐 C | 📅 2026-08-23 – jq builtins coded in *jq* itself, not C.
...
* [java-jq](https://github.com/arakelian/java-jq) ⭐ 92 | 🐛 8 | 🌐 Java | 📅 2024-04-30 – A jq wrapper for Java ([jackson-jq](https://github.com/eiiches/jackson-jq) ⭐ 310 | 🐛 42 | 🌐 Java | 📅 2026-08-29 is a Jackson extension).
