...
* [jq](https://jqlang.github.io/jq/) ([github](https://github.com/jqlang/jq) ⭐ 35,441 | 🐛 472 | 🌐 C | 📅 2026-08-12) – The original jq command-line JSON processor.
* [gojq](https://github.com/itchyny/gojq) ⭐ 3,793 | 🐛 13 | 🌐 Go | 📅 2026-07-20 – A jq implementation in Go.
...
* `echo '' | fzf --print-query --preview "cat *.json | jq {q}"` – An [fzf](https://github.com/junegunn/fzf) ⭐ 82,536 | 🐛 327 | 🌐 Go | 📅 2026-08-11 hack that turns it into an interactive jq explorer.
* [fq](https://github.com/wader/fq) ⭐ 10,556 | 🐛 57 | 🌐 Go | 📅 2026-08-12 – jq for binary formats
* [jnv](https://github.com/ynqa/jnv) ⭐ 6,088 | 🐛 31 | 🌐 Rust | 📅 2026-07-27 – interactive JSON filter using jq with navigation and autocompletion.
* [yq](https://github.com/kislyuk/yq) ⭐ 2,964 | 🐛 23 | 🌐 Python | 📅 2026-07-11 (and `xq`) – jq wrapper for YAML and XML documents.
* [jqp](https://github.com/noahgorstein/jqp) ⭐ 2,831 | 🐛 23 | 🌐 Go | 📅 2026-02-06 – a TUI playground for exploring jq.
* [jiq](https://github.com/fiatjaf/jiq) ⚠️ Archived – A visual command-line interactive JSON explorer with jq filters.
* [play](https://github.com/paololazzari/play) ⭐ 582 | 🐛 3 | 🌐 Go | 📅 2025-03-28 – A TUI playground to experiment with your favorite programs, such as grep, sed, awk, jq and yq.
...
* [jq play](https://jqplay.org/) ([github](https://github.com/jingweno/jqplay) ⭐ 843 | 🐛 27 | 🌐 TypeScript | 📅 2026-08-12) – A playground for jq with sharing capabilities.
...
* [bat syntax highlighting](https://github.com/jqlang/jq/wiki/bat-language-syntax) ⭐ 35,441 | 🐛 472 | 🌐 C | 📅 2026-08-12 – Syntax file to use bat to syntax highlight jq files
* [jq-mode](https://github.com/ljos/jq-mode) ⭐ 134 | 🐛 9 | 🌐 Emacs Lisp | 📅 2025-09-29 – A jq mode for Emacs.
...
* [vim-jqplay](https://github.com/bfrg/vim-jqplay) ⭐ 123 | 🐛 2 | 🌐 Vim Script | 📅 2024-03-05 – Interactive jq playground inside Vim.
* [bro/q](https://github.com/zalando-incubator/bro-q) ⚠️ Archived – A Chrome Extension for JSON formatting and jq filtering.
* [virtual-json-viewer](https://github.com/paolosimone/virtual-json-viewer) ⭐ 83 | 🐛 2 | 🌐 TypeScript | 📅 2026-07-12 – A JSON Chrome/Firefox Extension with virtual DOM, full-text search and jq filtering.
* [vscode-jq-playground](https://github.com/davidnussio/vscode-jq-playground) ⭐ 54 | 🐛 11 | 🌐 TypeScript | 📅 2026-08-12 – A jq playground notebook extension for VS Code.
...
* [vscode-jq](https://github.com/wader/vscode-jq) ⭐ 32 | 🐛 4 | 🌐 TypeScript | 📅 2026-08-11 – VSCode jq extension that uses [jq-lsp](https://github.com/wader/jq-lsp) ⭐ 132 | 🐛 7 | 🌐 jq | 📅 2026-08-03. Has syntax highlight, snippets and everything jq-lsp provides.
...
* [FAQ](https://github.com/jqlang/jq/wiki/FAQ) ⭐ 35,441 | 🐛 472 | 🌐 C | 📅 2026-08-12 – jq FAQ.
* [Cookbook](https://github.com/jqlang/jq/wiki/Cookbook) ⭐ 35,441 | 🐛 472 | 🌐 C | 📅 2026-08-12 – jq cookbook.
* [Advanced Topics](https://github.com/jqlang/jq/wiki/Advanced-Topics) ⭐ 35,441 | 🐛 472 | 🌐 C | 📅 2026-08-12 – jq advanced topics.
...
* [Builtins](https://github.com/jqlang/jq/blob/master/src/builtin.jq) ⭐ 35,441 | 🐛 472 | 🌐 C | 📅 2026-08-12 – jq builtins coded in *jq* itself, not C.
...
* [jc](https://github.com/kellyjonbrazil/jc) ⭐ 8,663 | 🐛 49 | 🌐 Python | 📅 2026-06-18 – CLI tool that converts the output of popular command-line programs and filetypes to JSON so they can be piped to jq.
...
* [gojq](https://github.com/itchyny/gojq) ⭐ 3,793 | 🐛 13 | 🌐 Go | 📅 2026-07-20 – A full jq implementation in Go, usable as a library.
...
* [pyjq](https://github.com/doloopwhile/pyjq) ⭐ 203 | 🐛 19 | 🌐 Python | 📅 2024-07-20 – A jq wrapper for Python.
* [jqr](https://github.com/ropensci/jqr) ⭐ 144 | 🐛 16 | 🌐 R | 📅 2024-12-14 – R interface to jq.
* [java-jq](https://github.com/arakelian/java-jq) ⭐ 92 | 🐛 8 | 🌐 Java | 📅 2024-04-30 – A jq wrapper for Java ([jackson-jq](https://github.com/eiiches/jackson-jq) ⭐ 310 | 🐛 42 | 🌐 Java | 📅 2026-08-12 is a Jackson extension).
