...
* [jq](https://jqlang.github.io/jq/) ([github](https://github.com/jqlang/jq) ⭐ 35,549 | 🐛 477 | 🌐 C | 📅 2026-09-01) – The original jq command-line JSON processor.
...
* `echo '' | fzf --print-query --preview "cat *.json | jq {q}"` – An [fzf](https://github.com/junegunn/fzf) ⭐ 82,814 | 🐛 329 | 🌐 Go | 📅 2026-09-04 hack that turns it into an interactive jq explorer.
* [fq](https://github.com/wader/fq) ⭐ 10,587 | 🐛 61 | 🌐 Go | 📅 2026-09-03 – jq for binary formats
* [jnv](https://github.com/ynqa/jnv) ⭐ 6,098 | 🐛 31 | 🌐 Rust | 📅 2026-08-20 – interactive JSON filter using jq with navigation and autocompletion.
...
* [bat syntax highlighting](https://github.com/jqlang/jq/wiki/bat-language-syntax) ⭐ 35,549 | 🐛 477 | 🌐 C | 📅 2026-09-01 – Syntax file to use bat to syntax highlight jq files
...
* [virtual-json-viewer](https://github.com/paolosimone/virtual-json-viewer) ⭐ 83 | 🐛 3 | 🌐 TypeScript | 📅 2026-08-30 – A JSON Chrome/Firefox Extension with virtual DOM, full-text search and jq filtering.
...
* [FAQ](https://github.com/jqlang/jq/wiki/FAQ) ⭐ 35,549 | 🐛 477 | 🌐 C | 📅 2026-09-01 – jq FAQ.
* [Cookbook](https://github.com/jqlang/jq/wiki/Cookbook) ⭐ 35,549 | 🐛 477 | 🌐 C | 📅 2026-09-01 – jq cookbook.
* [Advanced Topics](https://github.com/jqlang/jq/wiki/Advanced-Topics) ⭐ 35,549 | 🐛 477 | 🌐 C | 📅 2026-09-01 – jq advanced topics.
...
* [Builtins](https://github.com/jqlang/jq/blob/master/src/builtin.jq) ⭐ 35,549 | 🐛 477 | 🌐 C | 📅 2026-09-01 – jq builtins coded in *jq* itself, not C.
...
* [jc](https://github.com/kellyjonbrazil/jc) ⭐ 8,670 | 🐛 40 | 🌐 Python | 📅 2026-08-28 – CLI tool that converts the output of popular command-line programs and filetypes to JSON so they can be piped to jq.
...
* [java-jq](https://github.com/arakelian/java-jq) ⭐ 93 | 🐛 8 | 🌐 Java | 📅 2024-04-30 – A jq wrapper for Java ([jackson-jq](https://github.com/eiiches/jackson-jq) ⭐ 310 | 🐛 36 | 🌐 Java | 📅 2026-09-04 is a Jackson extension).
