...
* [jq](https://jqlang.github.io/jq/) ([github](https://github.com/jqlang/jq) ⭐ 35,580 | 🐛 480 | 🌐 C | 📅 2026-09-01) – The original jq command-line JSON processor.
...
* `echo '' | fzf --print-query --preview "cat *.json | jq {q}"` – An [fzf](https://github.com/junegunn/fzf) ⭐ 82,907 | 🐛 328 | 🌐 Go | 📅 2026-09-11 hack that turns it into an interactive jq explorer.
* [fq](https://github.com/wader/fq) ⭐ 10,596 | 🐛 57 | 🌐 Go | 📅 2026-09-10 – jq for binary formats
* [jnv](https://github.com/ynqa/jnv) ⭐ 6,102 | 🐛 31 | 🌐 Rust | 📅 2026-08-20 – interactive JSON filter using jq with navigation and autocompletion.
* [yq](https://github.com/kislyuk/yq) ⭐ 2,975 | 🐛 23 | 🌐 Python | 📅 2026-07-11 (and `xq`) – jq wrapper for YAML and XML documents.
* [jqp](https://github.com/noahgorstein/jqp) ⭐ 2,838 | 🐛 24 | 🌐 Go | 📅 2026-02-06 – a TUI playground for exploring jq.
...
* [bat syntax highlighting](https://github.com/jqlang/jq/wiki/bat-language-syntax) ⭐ 35,580 | 🐛 480 | 🌐 C | 📅 2026-09-01 – Syntax file to use bat to syntax highlight jq files
...
* [vscode-jq-playground](https://github.com/davidnussio/vscode-jq-playground) ⭐ 54 | 🐛 13 | 🌐 TypeScript | 📅 2026-09-10 – A jq playground notebook extension for VS Code.
...
* [FAQ](https://github.com/jqlang/jq/wiki/FAQ) ⭐ 35,580 | 🐛 480 | 🌐 C | 📅 2026-09-01 – jq FAQ.
* [Cookbook](https://github.com/jqlang/jq/wiki/Cookbook) ⭐ 35,580 | 🐛 480 | 🌐 C | 📅 2026-09-01 – jq cookbook.
* [Advanced Topics](https://github.com/jqlang/jq/wiki/Advanced-Topics) ⭐ 35,580 | 🐛 480 | 🌐 C | 📅 2026-09-01 – jq advanced topics.
...
* [Builtins](https://github.com/jqlang/jq/blob/master/src/builtin.jq) ⭐ 35,580 | 🐛 480 | 🌐 C | 📅 2026-09-01 – jq builtins coded in *jq* itself, not C.
...
* [java-jq](https://github.com/arakelian/java-jq) ⭐ 93 | 🐛 8 | 🌐 Java | 📅 2024-04-30 – A jq wrapper for Java ([jackson-jq](https://github.com/eiiches/jackson-jq) ⭐ 310 | 🐛 15 | 🌐 Java | 📅 2026-09-11 is a Jackson extension).
